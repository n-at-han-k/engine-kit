...
module EngineKit
  class Engine < ::Rails::Engine
    isolate_namespace EngineKit

    # Register importmap pins for Stimulus controllers
    initializer "engine_kit.importmap", before: "importmap" do |app|
    ...
    initializer "engine_kit.assets" do |app|
    ...
    initializer "engine_kit.helpers" do
      ActiveSupport.on_load(:action_view) do
        include EngineKit::ApplicationHelper
      end
    end
  end
end
